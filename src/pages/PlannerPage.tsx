...
export function PlannerPage(){
 ...
 return <div className="mx-auto max-w-6xl space-y-5 p-4 sm:p-6">
  ...
  {parsed&&data&&<>
   <Card><PlannerWeekNavigation weeks={parsed.weeks} selected={selectedWeek} onChange={selectWeek}/>{data.week.calendar&&<p className="mt-3 rounded-lg bg-amber-50 p-3 text-sm">Calendar: {data.week.calendar}</p>}</Card>
