...
export interface WeeklyPlanData { lessonRequirements?: { qualities?: string; eal?: string; learning?: string }; unitSnapshot?: UnitPlan[]; cardEditorVersion?: number; dismissedAssignedTexts?: string[]; weeklyResources?: import('./planner-bank').WeeklyResource[] }
